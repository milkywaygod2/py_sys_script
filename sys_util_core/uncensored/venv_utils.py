...
def create_venv(
    ...
    try:
        ...
        JLogger().log_error(f"Unexpected error creating virtual environment: {str(e)}")
...
def install_package(venv_path: str, package_name: str, 
    ...
    try:
        ...
        JLogger().log_error(f"Unexpected error installing package: {str(e)}")
...
def uninstall_package(venv_path: str, package_name: str, 
    ...
    try:
        ...
        JLogger().log_error(f"Unexpected error uninstalling package: {str(e)}")
...
def list_packages(venv_path: str, format: str = 'columns') -> Tuple[bool, str, List[Dict[str, str]]]:
    try:
        ...
        JLogger().log_error(f"Unexpected error listing packages: {str(e)}")
...
def upgrade_pip(venv_path: str) -> Tuple[bool, str]:
    try:
        ...
        JLogger().log_error(f"Unexpected error upgrading pip: {str(e)}")
...
def get_package_info(venv_path: str, package_name: str) -> Tuple[bool, Dict[str, str]]:
    try:
        ...
        JLogger().log_error(f"Unexpected error getting package info: {str(e)}")
        return False, {}
...
def freeze_requirements(venv_path: str, output_file: str) -> Tuple[bool, str]:
    try:
        ...
        JLogger().log_error(f"Unexpected error freezing requirements: {str(e)}")
...
def run_in_venv(
    ...
    try:
        ...
        JLogger().log_error(f"Failed to run command in venv: {str(e)}")
...
def install_requirements(venv_path: str, requirements_file: str) -> Tuple[bool, str]:
    try:
        ...
        JLogger().log_error(f"Unexpected error installing requirements: {str(e)}")
...
def ensure_pyinstaller(venv_path: str, version: Optional[str] = None) -> Tuple[bool, str]:
    try:
        ...
        JLogger().log_error(f"Unexpected error ensuring PyInstaller: {str(e)}")
