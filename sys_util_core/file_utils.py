...
def run_as_admin():
    ...
    try:
        ...
        raise _pyinstaller.PyInstallerError(f"Failed to elevate to administrator privileges: {str(e)}")
...
@brief	Namespace for PyInstaller-related. PyInstaller 관련을 위한 네임스페이스
"""
class _pyinstaller:
    """
