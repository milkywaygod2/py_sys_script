...
# 파일 인코딩
# Returns:
# ConfigParser object or None if error
# ConfigParser 객체, 에러시 None
# -------------------------------------------------------------------
...
# 점 표기법을 사용하여 중첩된 설정 값을 가져옵니다.
# Args:
# config: Configuration dictionary
# 설정 딕셔너리
# key_path: Dot-separated key path (e.g., 'database.host')
# 점으로 구분된 키 경로 (예: 'database.host')
