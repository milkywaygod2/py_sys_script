...
"""
@brief Extract a TAR archive. TAR 아카이브를 압축 해제합니다.
@param tar_file Path to TAR file TAR 파일 경로
@param extract_to Directory to extract to 압축 해제할 디렉토리
@return True if successful, False otherwise 성공하면 True, 실패하면 False
"""
...
"""
@brief List contents of a TAR archive. TAR 아카이브의 내용을 나열합니다.
@param tar_file Path to TAR file TAR 파일 경로
@return List of file names in archive or None if error 아카이브의 파일 이름 리스트, 에러시 None
"""
...
"""
@brief Get information about an archive file. 아카이브 파일에 대한 정보를 가져옵니다.
@param archive_file Path to archive file 아카이브 파일 경로
@return Dictionary with archive information or None if error 아카이브 정보 딕셔너리, 에러시 None
"""
...
"""
@brief Extract a single file from ZIP archive. ZIP 아카이브에서 단일 파일을 추출합니다.
@param zip_file Path to ZIP file ZIP 파일 경로
@param file_name Name of file to extract 추출할 파일 이름
@param extract_to Directory to extract to 추출할 디렉토리
@return True if successful, False otherwise 성공하면 True, 실패하면 False
"""
