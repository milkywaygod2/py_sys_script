...
# -------------------------------------------------------------------
# Ping a host and return success status and average response time.
# 호스트를 핑하고 성공 여부와 평균 응답 시간을 반환합니다.
# Args:
...
# 핑 시도 횟수
# Returns:
# Tuple of (success, average_time_ms)
# (성공 여부, 평균 시간 ms) 튜플
# -------------------------------------------------------------------
...
# 로컬 IP 주소를 가져옵니다.
# Returns:
# Local IP address or None if error
# 로컬 IP 주소, 에러시 None
# -------------------------------------------------------------------
...
# IP 주소에서 호스트명을 가져옵니다 (역방향 DNS 조회).
# Args:
...
# 인터넷 연결이 가능한지 확인합니다.
# Args:
# test_host: Host to test connection
# 연결 테스트할 호스트
# timeout: Connection timeout in seconds
# 연결 타임아웃 (초)
# Returns:
...
# 다운로드 타임아웃 (초)
# Returns:
# Download speed in Mbps or None if error
# 다운로드 속도 (Mbps), 에러시 None
# -------------------------------------------------------------------
