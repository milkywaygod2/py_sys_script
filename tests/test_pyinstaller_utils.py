...
class TestPyInstallerUtils(unittest.TestCase):
    ...
    def test_build_exe_with_pyinstaller(self):
        """Test build_exe_with_pyinstaller function exists and has correct signature"""
        # Just verify the function exists and can be called with correct parameters
        import inspect
        from pathlib import Path
        
        # Check function exists
        self.assertTrue(hasattr(pyinstaller_utils, 'build_exe_with_pyinstaller'))
        
        # Check function signature
        sig = inspect.signature(pyinstaller_utils.build_exe_with_pyinstaller)
